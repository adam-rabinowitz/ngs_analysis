...
def normaliseMatrix(inMatrix, excludeBin, binNames = None, outPrefix = None,
    path = 'ic_mes', memory = 4000, maxIter = 1000):
    ...
    # Calculate bias 
    biasCommand = [path, 
        tempMatrix, memory, str(binNo), maxIter, '0', '0', biasFile]
